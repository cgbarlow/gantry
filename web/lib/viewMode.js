...
//
// Deliberately session-only — unlike web/lib/theme.js, this never reads from or writes to localStorage, so a fresh page load always starts back at `split`; there is no "next visit" to carry it across.
