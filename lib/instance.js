...
function githubClientFor(options) {
  ...
  return { client: resolveContentStore('github', { owner, repository, pat, baseUrl }), branch }
}
...
function gitlabClientFor(options) {
  ...
  return { client: resolveContentStore('gitlab', { namespace, repository, pat, baseUrl }), branch }
}
