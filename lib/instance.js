...
export async function recordInstancePullRequest(slug, stageId, pullRequestId, options = {}) {
  if (!options.azureDevOps && !options.github && !options.gitlab) {
    throw new Error('recordInstancePullRequest is for Workspace-backed instances only — pass options.azureDevOps, options.github or options.gitlab')
  }
...
export async function recordInstancePullRequestStatus(slug, stageId, status, options = {}) {
  if (!options.azureDevOps && !options.github && !options.gitlab) {
    throw new Error('recordInstancePullRequestStatus is for Workspace-backed instances only — pass options.azureDevOps, options.github or options.gitlab')
  }
  if (status === undefined) {
...
export async function clearInstanceReopened(slug, stageId, options = {}) {
  if (!options.azureDevOps && !options.github && !options.gitlab) {
    throw new Error('clearInstanceReopened is for Workspace-backed instances only — pass options.azureDevOps, options.github or options.gitlab')
  }
  const { client, branch } = options.azureDevOps
    ? azureDevOpsClientFor(options)
    : options.github
