...
export function githubOutPath(slug, instanceName, artefactTitle, extension = 'docx') {
  assertValidAzureDevOpsSlug(slug)
  return `${AZURE_DEVOPS_WORKSPACE_ROOT}/${slug}/out/${renderedArtefactBasename(instanceName, artefactTitle)}.${extension}`
}
...
export function gitlabOutPath(slug, instanceName, artefactTitle, extension = 'docx') {
  assertValidAzureDevOpsSlug(slug)
  return `${AZURE_DEVOPS_WORKSPACE_ROOT}/${slug}/out/${renderedArtefactBasename(instanceName, artefactTitle)}.${extension}`
}
...
export function atlassianOutPath(slug, instanceName, artefactTitle, extension = 'docx') {
  assertValidAzureDevOpsSlug(slug)
  return `${AZURE_DEVOPS_WORKSPACE_ROOT}/${slug}/out/${renderedArtefactBasename(instanceName, artefactTitle)}.${extension}`
}
