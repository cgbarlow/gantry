...
import { PROVIDER as GITHUB_PROVIDER } from './githubClient.js'
...
async function createInstanceInGitHub(definitionId, slug, definition, firstStage, options) {
  ...
  if (!(await client.repoExists())) {
    throw new RepoNotFoundError(`GitHub repository ${location} does not exist — create it on GitHub first.`, { provider: GITHUB_PROVIDER })
  }
