...
/**
 * Walks node_modules from a set of root specifiers, following each
 * package's own "dependencies", and returns a browser import map that
 * points every bare specifier at its real ESM entry file under
 * /node_modules/ — so the web form can `import` these packages with no
 * bundler, exactly as installed by `npm install`.
 */
