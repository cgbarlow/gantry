    ...
    try {
      ...
      if (url.pathname === '/api/workspaces' && req.method === 'GET') {
        ...
        sendJSON(
          res,
          200,
          listWorkspaces({ instancesDir }).map((workspace) => ({
            ...workspace,
      ...
      if (url.pathname === '/api/instance' && req.method === 'GET') {
        ...
        sendJSON(res, 200, buildInstanceResponse(slug, definitionsDir, definition, stage, instance, modules, false, null, null, instancesDir))
        return
      }
