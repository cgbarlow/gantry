...
import { readInstance, readModule, writeModule, createInstance, updateInstanceAssignee, updateInstanceRequiredReviewer } from './instance.js'
...
function buildInstanceResponse(slug, definitionsDir, definition, stage, instance, modules, isWorkspaceBacked, pullRequest = null) {
  return {
    slug,
      ...
      if (url.pathname === '/api/instance' && req.method === 'GET') {
        ...
        if (azureDevOpsLocation) {
          await withAzureDevOpsCredential(req, res, azureDevOpsLocation, async (azureDevOpsBase) => {
            ...
            sendJSON(res, 200, buildInstanceResponse(slug, definitionsDir, definition, stage, instance, modules, true, pullRequest))
          })
          return
        }
      ...
      if (url.pathname === '/api/identities' && req.method === 'GET') {
        ...
        if (!orgProject) {
          ...
          if (workspaces.length > 0) {
            orgProject = { organization: workspaces[0].organization, project: workspaces[0].project }
          }
        }
        if (!orgProject) {
