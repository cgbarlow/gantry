...
import { renderArtefact, renderStageArtefacts, prepareAzureDevOpsWasmRender, finishAzureDevOpsWasmRender, externaliseImagesForWasm } from './render.js'
...
function resolveLocalDataDir(slug, instancesDir, scopeId) {
  let location
  try {
    location = resolveInstanceLocation(slug, { instancesDir, scopeId })
  } catch {
    return instancesDir
  }
