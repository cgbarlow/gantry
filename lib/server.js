...
import { parseBootstrapWorkspaces, applyBootstrapWorkspaces } from './workspaceBootstrap.js'
import {
  registerWorkspace,
  listWorkspaces,
  updateWorkspace,
...
export function createServer(options = {}) {
  ...
  if (options.migrateWorkspacesOnStart) {
    ...
    applyBootstrapWorkspaces(parseBootstrapWorkspaces(rawBootstrapWorkspaces), { instancesDir })
  }
