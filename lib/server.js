...
export function createServer(options = {}) {
  ...
  return createHttpServer(async (req, res) => {
    try {
      ...
      // own nested shape. A body with no `provider` is the pre-#19 flat shape (`{ organization,
