...
import { resolveInstanceLocation } from './instanceRegistry.js'
 ...
 * number of registered remote instances. The multi-instance registry routes
 * (`GET`/`POST /api/instances`) always operate on the local `instancesDir`
 * regardless of what any individual instance's own location is.
 *
