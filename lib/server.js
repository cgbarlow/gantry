...
export function createServer(options = {}) {
  ...
  // /api/identities`'s own `provider=gitlab` branch is the first route to consult it — workspace
  // registration's own `baseUrl` gating (the `POST /api/workspaces` twin of `allowGitHubBaseUrlOverride`
  // above) is #25's job, not yet wired as of this ticket.
