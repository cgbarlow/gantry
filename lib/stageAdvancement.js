 ...
 * Request is merged (docs/adr/0014-pull-request-stage-approval.md, #122-
 * #125's own mechanism), a self-serve write like this one playing no part
 * in that flow. Callers (lib/server.js's `POST /api/instance/advance-stage`)
