...
// `main`, overwriting any previous render of that artefact (the repo's own
// history is the audit trail — no reason to also keep every past render as
// a distinct file). A dry run never reaches this — `compileArtefact`
// returns before writing anything, local or remote.
//
