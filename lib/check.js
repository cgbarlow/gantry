...
// as the Azure DevOps half below, over an instance/its modules read from a GitHub repo instead. The
// caller supplies `options.github.branch` for the stage branch (#188); without one every read falls
// through to `main`, `lib/githubClient.js`'s own default.
