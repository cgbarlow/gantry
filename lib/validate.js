...
/**
 * `gantry validate <definitionId>`: reports every structural problem with a
 * definition in one pass, instead of `loadDefinition`'s fail-fast behavior
 * (fix one YAML error, rerun, hit the next).
 */
