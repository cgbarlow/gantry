...
// scale, GitHub's APPROVED/CHANGES_REQUESTED/COMMENTED/DISMISSED per docs/adr/0040, or GitLab's
// approval-toggle-plus-unresolved-thread reading per docs/adr/0041) — each provider's own
// pull-requests client returns whichever raw shape its API produces (`reviewers`, `reviews`, or
// `approvals`/`discussions`), so this is the one place that picks the right interpreter for it.
