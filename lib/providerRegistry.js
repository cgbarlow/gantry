...
const providers = {
  ...
  // #20 — pull requests, scoped to what Promote needs: open/read/request-reviewer, no merge) —
  // workItems joins once #14 builds it, the same incremental registration this file's own doc
  // comment describes.
  github: {
