...
export { DEFAULT_BASE_URL, DEFAULT_API_VERSION }

/**
 * Returns true when a RequestError is a TF51535 field-not-found
...
export function createAzureDevOpsWorkItemsClient({
   ...
   *
   * Throws NotFoundError if no work item exists for `id` (e.g.
