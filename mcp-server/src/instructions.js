...
3. A tool call that fails with "missing_workspace_pat" means the operator needs to add that workspace to this server's GANTRY_WORKSPACE_PATS — you cannot fix this yourself; report it back to the operator verbatim.
